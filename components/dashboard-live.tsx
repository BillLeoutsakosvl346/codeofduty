    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.42fr)_minmax(360px,.58fr)]">
      <div className="space-y-6">
        <Card>
          ...
          <div>{data.leaderboard.map((player) => <a href={`/player/${player.id}`} key={player.id} className="group grid grid-cols-[42px_1fr_auto] items-center gap-3 border-b border-white/[0.07] px-5 py-5 transition last:border-0 hover:bg-white/[0.03] sm:grid-cols-[52px_1fr_100px_130px]">
